...
3. Passende Notiz(en) in `02_KNOWLEDGE/` anlegen oder bestehende ergänzen. Lieber wenige gute Notizen als viele Schnipsel.
...
1. Erst im Vault suchen (`02_KNOWLEDGE/`, dann Rest). Vorhandenes Wissen schlägt neue Recherche.
