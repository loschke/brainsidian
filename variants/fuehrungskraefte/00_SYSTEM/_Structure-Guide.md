...
2. **Wissen** ist das, was Claude daraus baut: verlinkte Notizen in `08_KNOWLEDGE/` und den anderen Inhaltsordnern. Diese Schicht wächst und wird gepflegt.
...
|--------|-------|----------|
| **Ordner** | Wo gehört es hin? | `04_PROJECTS/` |
